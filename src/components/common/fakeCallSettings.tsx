...
export default function FakeCallSettings({onSave}: {onSave: (settings: any) => void}) {
    ...
    return(
      ...
      <select className="w-full mb-4" value={ringtone} onChange={(e) => setRingtone(e.target.value)}>
      ...
      <select className="w-full mb-4" value={voice} onChange={(e) => setVoice(e.target.value)}>
